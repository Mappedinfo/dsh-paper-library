...
export const inject = ['slots', 'locale', 'sidebarRightTabs', 'modelDirectories', 'sessions']

/** The reader exists only while its pane is visible; no background PDF renderer. */
export function LibraryPane({ useTabInfo, t, sessionId, directory, modelAvailable }) {
...
export function apply(ctx) {
  ctx.effect(() => ctx.locale.register(NS, {
    zh: { title: '文献库', description: '检索、引用、PDF 批注与 AI 反馈' },
    en: { title: 'Paper Library', description: 'Search, cite, annotate PDFs and review AI feedback' },
