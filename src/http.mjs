...
for (const name of ['board.js','board.css','board-source.js','board-render.js','board-bridge.js','board-mermaid.js']) staticFiles[name] = [name, name.endsWith('.js') ? 'text/javascript;charset=utf-8' : 'text/css;charset=utf-8'];
