...
export function resolveConfig(raw = {}) {
  ...
  return { library: resolve(library), python: raw.python, provider: raw.provider, model: raw.model, maxOutputTokens, requireToolApproval: raw.requireToolApproval ?? true }
}
