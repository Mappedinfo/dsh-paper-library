...
for (const path of ['LICENSE','THIRD_PARTY.md','licenses/AGPL-3.0.txt','licenses/citeproc-NOTICE.txt','skills/paper-library-fetch/SKILL.md']) assert.ok(paths.has(path),`Missing packaged notice/skill: ${path}`);
