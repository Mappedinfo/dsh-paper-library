...
parser.add_argument("--checkpoint",choices=["initial","intake","publication","promotion","paper-conversations","annotation-references","workbench","reader"],default="initial")
