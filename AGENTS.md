...
- Tests use synthetic documents only. Keep reproducible validation scripts and docs. Commit task changes after passing checks; no remote/publication is configured.
